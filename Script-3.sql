...
CREATE TABLE [dbo].[thirtybees.V1.raw]
(
...
SELECT * FROM [thirtybees.V1.raw];

CREATE TABLE [dbo].[thirtybees.V1.production]
(
...
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD WebshopCheck varchar(10) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD WebshopCheckNotes varchar(200) go	
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD companyName varchar(100) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD linkedinAPI varchar(100) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD linkedinCompanyPage varchar(100) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD linkedinCompanyParentPage varchar(100) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD linkedinNotes varchar(200) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD country varchar(50) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD qualityCheck varchar(50) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD lock varchar(10) go

ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.date_4]	VARCHAR(30) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.date_5]	VARCHAR(30) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.date_6]	VARCHAR(30) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.count_4] NUMERIC(10,0) go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.count_5] NUMERIC(10,0)go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [visitData.count_6] NUMERIC(10,0)go
ALTER TABLE ecommercedb.dbo.[thirtybees.V1.production] ADD [webshopchecker]	VARCHAR(50) go
